...
class FileExplorer(QWidget):
    ...
    def create_controls(self):
        ...
        color_btn = QPushButton("Set Colors")
        color_btn.clicked.connect(self.set_colors)
    ...
    def set_colors(self):
        ...
        pane_color = QColorDialog.getColor(QColor(self.pane_bg_color), self, "Select Pane Background Color")
        if pane_color.isValid():
            self.pane_bg_color = pane_color.name()
    ...
    def apply_colors(self):
        ...
        for pane in [self.left_pane, self.right_pane]:
            pane["file_list"].setStyleSheet(f"background-color: {self.pane_bg_color};")
        ...
        if os.path.exists(CONFIG_FILE):
            try:
                with open(CONFIG_FILE, "r") as f:
                    ...
                    self.pane_bg_color = data.get("pane_bg_color", "#f0f0f0")
            except Exception as e:
    ...
    def closeEvent(self, event):
        try:
            data = {
                ...
                "pane_bg_color": self.pane_bg_color
            }
