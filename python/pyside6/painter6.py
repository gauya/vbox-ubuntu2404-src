...
from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout,
                               ...
                               QLabel, QFileDialog, QComboBox, QInputDialog)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        save_action.triggered.connect(self.show_save_dialog)  # 변경
    ...
    def show_save_dialog(self):
        ...
        file_path, _ = file_dialog.getSaveFileName()  # 저장할 파일 이름 입력 받기
        if file_path:
            if len(file_path) < 5 or file_path[-4:] not in (".png",".bmp",".jpg",".jpeg"):
                file_path += ".png"
